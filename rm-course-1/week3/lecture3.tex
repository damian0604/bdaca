...
\onslide<3->{
\scriptsize{For example, we are running DMI-TCAT (Borra \& Rieder, 2014) on a cloud computing platform.}
\tiny{\\ ~ \\
Borra, E., \& Rieder, B. (2014). Programmed method: Developing a toolset for capturing and analyzing tweets. \emph{Aslib Journal of Information Management, 66}(3), 262–278. doi:10.1108/AJIM-09-2013-0094}
}
\end{frame}
