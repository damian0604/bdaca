...
% WE HEBBEN DIT AL GEDAAN TIJDENS DE WERKGROEPBIJEENKOMST (week2/tutorial2) VANWEGE CORONA
\iffalse
...
\begin{block}{Before Thursday meeting}
Post all questions about Chapters 5.1--5.4 on Canvas!
\end{block}

\begin{block}{Suggestion for additional exercise}
  If you want to exercise your skills a bit more, try Appendix B (Parsing your own WhatsApp chats)!
  {\footnotesize (Before you despair: The given solution does not handle messages with a newline in the middle of it -- but if you want to, we can discuss possible approaches. Just post your ideas on Canvas.)}
\end{block}
