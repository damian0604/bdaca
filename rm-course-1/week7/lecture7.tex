...
\begin{frame}{Ressources}
  \begin{itemize}
  \item Book, Chapter 10 and Chapter 11
    \item \url{https://github.com/damian0604/bdaca/blob/master/rm-course-2/week12/lda.ipynb}
    \item \url{https://github.com/annekroon/gesis-ml-learning}
  \end{itemize}
