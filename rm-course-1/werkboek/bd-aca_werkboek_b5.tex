...
In week 5, the midterm take-home exam is distributed after the Friday meeting. The answer sheets and all files have to be handed in no later than the day before the next meeting, i.e. Sunday evening (5--5, 23.59).
...
We will not be able to do all of this in this course, but you learn where to look for ressources in case you want to go on with computational methods.
...
\subsection*{Open Lab (date will be announced)}
{\footnotesize{(Damian and Joanna)}\\}
