...
\begin{frame}[plain]
  ...
  \item Use a dataset of your choice. Try to compare multiple approaches (e.g., clustering vs LDA). Possible inspiration: \url{https://github.com/annekroon/gesis-ml-learning/blob/master/03wednesday/livecoding.ipynb}
    \end{itemize}
\end{block}
