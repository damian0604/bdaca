...
Alternatively, and to enjoy more comfort, you can use a graphical interface called: just type \texttt{spyder3} instead of \texttt{python3}. You also also installed \texttt{ipython3}, which is some kind of luxury version of \texttt{python3}, meaning it offers some more help and interactive features.
