...
You also also installed \texttt{ipython3}, which is some kind of luxury version of \texttt{python3}. Meaning it offers some more help and interactive features. It is, for example, better with graphics, and it is easier to copy-paste code. 
...
print("Hello world!")
\end{lstlisting}
Save it as \texttt{/home/damian/hello.py} and go back to your linux shell. The first line is a so-called shebang, it tells your computer how to run the program later on.

Go to your home directory and tell the shell that the file you just wrote is a program and that you are allowed to run it (you just have to do  once).
\begin{lstlistingbash}
cd /home/damian
chmod u+x hello.py
\end{lstlistingbash}
...
For more information, have a look at the books by \cite{McKinney2012} and \cite{Russel2013}. We will also cover it more in detail in Chapter~\ref{chap:statistics}.
...
\begin{itemize}
	...
	\item Jupyter Notebook as a useful tool specialized in data \emph{analysis}
\end{itemize}
...
\todo[inline]{INKORTEN, COMMENTS ANDERS OPMAKEN}
...
Once you have fitted both vectorizer and classifier, you can save them as follows (assuming you have called your instance of the vectorizer \texttt{vectorizer} and your classifier \texttt{nb}):
...
\todo[inline]{insert URL once everything is up}
...
\chapter[Hint 1: Exchanging files]{Hint 1: Exchanging files by mounting your host system}
