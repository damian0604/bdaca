...
\title[Automated Content Analysis with Python]{\textbf{Four-day workshop\\ Automated Content Analysis with Python} \\ Day 3}
...
\begin{frame}{Try it yourself!}
	\huge
	\url{https://github.com/damian0604/bdaca/blob/master/ipynb/ic2s2.ipynb}
\end{frame}
