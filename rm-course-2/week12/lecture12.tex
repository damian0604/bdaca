...
23.59 deadline take home
\end{block}

\begin{block}{Friday}
Continue working on dataset from last week. By the end of the session, I'd like to see some comparison of multiple approaches (e.g., clustering vs LDA)
\end{block}

\begin{block}{Wednesday: Word embeddings}
