...
\title[Big Data and Automated Content Analysis]{\textbf{Big Data and Automated Content Analysis\\ Part I+II} \\ Week 11 -- Wednesday \\ »Unupervised Machine Learning I«}
...
\begin{itemize}
	\item gives no guidance on how to determine $k$
...
\begin{frame}[fragile,plain]{Exercise for during Friday's lab session}
